...
class Console(object):
    ...
    def __init__(self, roms_path, game_id, cheat_debugger=False, render=True, throttle=False, debug=False, mess=False, mess_file=""):
        ...
        if mess:
            command += f" -dump '{str(Path(roms_path).absolute())}/{mess_file}'"
